    ...
    def getNewsFeed(self, userId: int) -> List[int]:
        ...
        for cur_user in self.user_followers[userId]:
            ...
            if tweets:
                ...
                heapq.heappush(max_heap, (-time_stamp, tweet_id, cur_user, index - 1))
        ...
        while max_heap and len(res) < self.feed_limit:
            ...
            res.append(tweet_id)
            if index >= 0:
                time_stamp, next_tweet_id = self.user_tweets[cur_user][index]
                heapq.heappush(max_heap, (-time_stamp, next_tweet_id, cur_user, index - 1))
